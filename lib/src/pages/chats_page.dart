    ...
    return Scaffold(
      ...
      body: BlocConsumer<ChatsListBloc, ChatsListState>(
        listener: (context, state) {
          ...
          } else if (state is ChatListChatPressSuccess) {
            context.beamToNamed(
                '/${widget.userId}/chats/${state.chatCompanionId}');
          }
        },
        ...
        children: [
          Expanded(
            child: GestureDetector(
              onTap: () {
                context.read<ChatsListBloc>().add(ChatsListChatPressed(
                                ...
                                children: [
                                  ...
                                  if (chat.unreadMessageCount > 0)
                                    Container(
                                      height: 30,
                                      width:
                                          '${chat.unreadMessageCount}'.length >
                                                  3
                                              ? null
                                              : 30,
